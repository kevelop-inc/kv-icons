...
function App() {
  return (
    <>
      ...
      <Arrow direction="up" className="fill-red size-10 rotate-90" />
      <Circle className="stroke-red size-10" />
      <Chevron direction="up" className="stroke-red size-10" />
      ...
      <Check strokeWidth="5" color="red" className="size-10" />
      <DotsHorizontal color="red" className="size-10" />
